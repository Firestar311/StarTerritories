...
public abstract class Nation extends Territory implements Nameable, Plottable, Permissible {
    ...
    protected int maxPlots, maxResidents, maxMunicipalities;
    
    public Nation(String id, Owner owner, int maxPlots, int maxResidents, int maxMunicipalities) {
        super(id, owner);
        this.maxPlots = maxPlots;
        this.maxResidents = maxResidents;
        this.maxMunicipalities = maxMunicipalities;
    }
    
    public void addTerritory(Territory territory) {
        if (!(territory instanceof Property) || !(territory instanceof Municipality)) {
